...
class AdForm extends Component {
    ...
    handleSubmit(e) {
        ...
        e.preventDefault();
        const newComment = { image: this.state.image, askingPrice: this.state.askingPrice, category: this.state.category, description: this.state.description, title: this.state.title }
